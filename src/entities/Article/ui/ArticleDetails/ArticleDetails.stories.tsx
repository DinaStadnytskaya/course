...
const article: Article = {
    ...
    subtitle:
    'In this Reactjs tutorial, we will learn about How to Get/Detect Window Size(Height & Width) in React js. React Js get window height& width on window resize; In this tutorial, you will learn how to detect the dynamic window width and height on window resize using react useState and useEffect hooks.',
    img:
    'https://blog.logrocket.com/wp-content/uploads/2019/05/create-react-app-getting-started.png',
    views: 654,
    ...
    blocks: [
        ...
        },
        {
            ...
            src:
        'https://cbsedu.blob.core.windows.net/course-video-covers/course-video-covers-9e140169-c4e7-414d-ae41-a855a5ad48f8.jpg',
